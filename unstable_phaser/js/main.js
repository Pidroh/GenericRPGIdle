...
GRIControl.prototype = {
	setupTitle: function() {
		...
		haxe_Log.trace(res,{ fileName : "Sources\\GRI/GRIControl.hx", lineNumber : 188, className : "GRIControl", methodName : "setupTitle"});
...
GRIControlEquip.prototype = {
	...
	,update: function() {
		...
		if(hoveredEquip >= 0) {
			...
			haxe_Log.trace(this.equipView.hover_Header.text,{ fileName : "Sources\\GRI/GRIControlEquip.hx", lineNumber : 168, className : "GRIControlEquip", methodName : "update"});
...
GRIView.prototype = {
	...
	,setupTitleTabButtons: function() {
		this.addButton(GRIView.tagTabTitle,"Title",GRIView.ARCHETYPE_BUTTON_TAB,"tabbutton",GRIView.TAG_TAB_BUTTON);
		this.tabTags.push(GRIView.tagTabTitle);
	}
	,setupTabButtons: function() {
		this.addButton(GRIView.tagTabRegion,"Region",GRIView.ARCHETYPE_BUTTON_TAB,"tabbutton",GRIView.TAG_TAB_BUTTON);
		this.addButton(GRIView.tagTabBattle,"Battle",GRIView.ARCHETYPE_BUTTON_TAB,"tabbutton",GRIView.TAG_TAB_BUTTON);
		this.addButton(GRIView.tagTabEquip,"Equipment",GRIView.ARCHETYPE_BUTTON_TAB,"tabbutton",GRIView.TAG_TAB_BUTTON);
		this.addButton(GRIView.tagTabMemory,"Memory",GRIView.ARCHETYPE_BUTTON_TAB,"tabbutton",GRIView.TAG_TAB_BUTTON);
		this.addButton(GRIView.tagTabCharacter,"Achievement",GRIView.ARCHETYPE_BUTTON_TAB,"tabbutton",GRIView.TAG_TAB_BUTTON);
	...
	,setupMiscBattle: function() {
		...
		var autoAdv = this.addButtonImage("autoadvance",Sprite.create("arrowlefttriple",30,13),GRIView.ARCHETYPE_BUTTON_SMALL,"subbuttons",null,true);
	...
	,addButton: function(id,label,archetype,layoutId,tag) {
		...
		button.styleDisabled.color = GRIView.COLOR_DISABLED_BUTTON;
...
GRIViewTitle.prototype = {
	...
	,setupUI: function() {
		...
		var e = this.view.addText("","Version: 0.04r",GRIView.ARCHETYPE_HEADER_TIMID,null);
...
GameAnalyticsIntegration.InitializeCheck = function() {
	...
	var platform = "gitphaser";
        ...
        if(gameanalytics.GameAnalytics != null && gaInited == false){
            gaInited = true;
            gameanalytics.GameAnalytics.configureBuild(("0.04r" + platform));
...
StoryControlLogic.update = function(update,controlData,executer) {
	...
	if(runtime.cutsceneStartable != null && runtime.cutscene == null) {
		...
		viewGRI.ui.genUI.updateAll();
		haxe_Log.trace("Cutscene Start",{ fileName : "Sources\\GRI/StoryControl.hx", lineNumber : 166, className : "StoryControlLogic", methodName : "update"});
	}
...
GRIView.COLOR_DISABLED_BUTTON = 3881790;
