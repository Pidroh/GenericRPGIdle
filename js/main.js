...
AchievementModel.prototype = {
	createAchievements: function() {
		this.modelData.achievements = new AchievementGroup();
		var as = this.modelData.achievements;
		var a = new Achievement("test4","Beginner's Door","Clear your first area",Sprite.create("achiev_a1",64,64));
		a.conditions.push(Condition.createWithKeyAndData(ConditionType.largerOrEqual,"maxarea_region0",2));
		as.achievements.push(a);
		var a = new Achievement("test5","Death to the Boss","Get through your first gate area",Sprite.create("achiev_a2",64,64));
		a.conditions.push(Condition.createWithKeyAndData(ConditionType.largerOrEqual,"maxarea_region0",6));
		as.achievements.push(a);
		var a = new Achievement("test6","A bit of experience","Get through 20 areas",Sprite.create("achiev_a3",64,64));
		a.conditions.push(Condition.createWithKeyAndData(ConditionType.largerOrEqual,"maxarea_region0",21));
		as.achievements.push(a);
		var a = new Achievement("test1","Step of Glory A","Clear Area 5 of Wolf Fields ",Sprite.create("achiev_e1",64,64));
		as.achievements.push(a);
		a.conditions.push(Condition.createWithKeyAndData(ConditionType.largerOrEqual,"maxarea_region1",6));
		var a = new Achievement("test2","Step of Glory B","Clear Area 10 of Tonberry's Lair",Sprite.create("achiev_e2",64,64));
		as.achievements.push(a);
		a.conditions.push(Condition.createWithKeyAndData(ConditionType.largerOrEqual,"maxarea_region2",11));
		var a = new Achievement("test3","Step of Glory C","Clear Area 15 of Altar Cave",Sprite.create("achiev_e3",64,64));
	...
	,update: function() {
		...
		var _g_current = 0;
		var _g_array = this.modelData.achievements.achievements;
...
var BattleManager = function() {
	...
	if(bm.regionPrizes.length > bm.regionRequirements.length) {
		haxe_Log.trace("PROBLEM: Tell developer to add more region requirements!!!",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 1044, className : "BattleManager", methodName : "new"});
	}
...
BattleManager.prototype = {
	...
	,isXPCap: function() {
		if(this.wdata.hero.xp.value > this.wdata.hero.xp.calculatedMax * 5) {
			return true;
		}
		return false;
	}
	...
	,DiscardWorseEquipment: function() {
		...
		while(i < this.wdata.hero.equipment.length) {
			++times;
			if(times > 500) {
				haxe_Log.trace("LOOP SCAPE",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2301, className : "BattleManager", methodName : "DiscardWorseEquipment"});
				break;
			}
			var e = this.wdata.hero.equipment[i];
			if(e == null) {
			...
			while(j < this.wdata.hero.equipment.length) {
				++times2;
				if(times2 > 500) {
					haxe_Log.trace("LOOP SCAPE 2",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2318, className : "BattleManager", methodName : "DiscardWorseEquipment"});
					break;
				}
	...
	,testInitializeRetentionWorldVersion: function(loadedWdata) {
		if(loadedWdata.retention == null) {
			...
			haxe_Log.trace(loadedWdata.retention.gameStartDate,{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2465, className : "BattleManager", methodName : "testInitializeRetentionWorldVersion"});
		...
		try {
			...
			haxe_Log.trace("normal date",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2470, className : "BattleManager", methodName : "testInitializeRetentionWorldVersion"});
		} catch( _g ) {
			var tmp = HxOverrides.dateStr(new Date());
			loadedWdata.retention.gameStartDate = tmp;
			haxe_Log.trace("Buggy date fix!",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2473, className : "BattleManager", methodName : "testInitializeRetentionWorldVersion"});
		}
	}
	...
	,SendJsonPersistentData: function(jsonString,verbose) {
		...
		try {
			...
			if(loadedWdata.worldVersion <= 3003) {
				haxe_Log.trace("legacy save ",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2486, className : "BattleManager", methodName : "SendJsonPersistentData"});
				loadedWdata = this.sendJsonLegacy(jsonString);
			}
		} catch( _g ) {
			var e = haxe_Exception.caught(_g);
			haxe_Log.trace("load save failed ",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2491, className : "BattleManager", methodName : "SendJsonPersistentData"});
			haxe_Log.trace(e.get_message(),{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2492, className : "BattleManager", methodName : "SendJsonPersistentData"});
			return false;
		}
...
GRIAchievementViewLogic.update = function(achievModel,view,griView) {
	var achievs = achievModel.achievements;
	var data = achievModel.achievementData;
	while(view.elements.length < achievs.achievements.length) {
	...
	var _g_current = 0;
	var _g_array = achievs.achievements;
	while(_g_current < _g_array.length) {
		var _g1_value = _g_array[_g_current];
		var _g1_key = _g_current++;
		var index = _g1_key;
		var value = _g1_value;
		var e = view.elements[index];
...
GRIControl.prototype = {
	setupTitle: function() {
		...
		haxe_Log.trace(res,{ fileName : "Sources\\GRI/GRIControl.hx", lineNumber : 196, className : "GRIControl", methodName : "setupTitle"});
		...
		var privacyAcceptance = CrossTarget.GetLocalStorageItem(key);
	...
	,update: function(miliseconds) {
		...
		if(this.view.feedbackButton != null) {
			this.showFeedback = this.view.feedbackButton.clickedThisFrame;
		...
		if(this.saveCount <= 0 || this.battleManager.prestiged) {
			...
			var masterPers = { worldVersion : bm.wdata.worldVersion, jsonGameplay : json, jsonStory : json2, jsonGeneral : null};
		...
		if(bm.isXPCap() == false) {
			...
			this.view.xpBar.mainText.text = "MAX";
		}
		...
		var storyHappened = this.storyControl.runtime.persistence.progressionData.h[this.storyControl.runtime.cutscenes[0].title].timesCompleted > 0;
		...
		GRIControl.refreshAreaName(bm,this.regionControl.visualizedRegion,regionProgress.maxArea,this.areaNames,this.lagrimaAreaLabels);
	...
	,getReviewJson: function(recommended,reviewText) {
		...
		return JSON.stringify({ recommended : recommended + "", message : reviewText, userId : userId});
	}
...
GRIControlEquip.prototype = {
	...
	,update: function() {
		...
		if(hoveredEquip >= 0) {
			...
			haxe_Log.trace(this.equipView.hover_Header.text,{ fileName : "Sources\\GRI/GRIControlEquip.hx", lineNumber : 167, className : "GRIControlEquip", methodName : "update"});
	...
	update: function() {
		...
		if((areaChanged || regionChanged) && hoverArea >= 0) {
			...
			if(hoverArea != 0) {
				...
				this.viewRegion.enemyHeader.text = "ENEMY DATA     " + GRIControlRegion.enemyRegionNames[this.visualizedRegion] + " " + this.areaFeed.feedLists[0].feedList[this.lastAreaVisualized].text;
			} else {
...
TitleMode.__constructs__ = [TitleMode.ACCEPT,TitleMode.NORMAL];
...
GRIControlTitle.prototype = {
	...
	,update: function() {
		...
		this.control.view.ui.elementVisibility(GRIViewTitle.DATA_CONTINUE,continueV);
		if(continueV == false) {
		...
		while(_g < _g1.length) {
			...
			if(data.stringData == GRIViewTitle.DATA_ACCEPT) {
				...
				CrossTarget.SetLocalStorageItem(GRIControl.PRIVACY_ACCEPTANCE_KEY,privacyAcceptance);
...
GRIView.prototype = {
	...
	,setupMisc: function() {
		...
		this.uiCreation.tags.length = 0;
		var v = this.feedbackButton;
		this.ui.keyboardManager.buttonPressToElementTrigger.h[GRIButtons.FEEDBACK_BUTTON] = v;
	}
	...
	,endDialog: function() {
		...
		haxe_Log.trace("END DIALOG",{ fileName : "Sources\\GRI/GRIView.hx", lineNumber : 374, className : "GRIView", methodName : "endDialog"});
	...
	,addButton: function(id,label,archetype,layoutId,tag,cursorGroup) {
		...
		button.styleHover.colorText = GRIView.COLOR_ACTIVE_PINK;
		button.styleHover.sprite = Sprite.create("purplegradient",32,32);
		...
		button.styleDisabledHover.sprite = Sprite.create("purplegradient",32,32);
		if(button.styleSelected == null) {
			...
			button.styleSelectedHover.sprite = Sprite.create("purplegradient",32,32);
		}
		if(tag != null) {
...
GRIViewEquip.prototype = {
	setup: function() {
		...
		this.cursor_items.noElementActivateGroup.set(Direction.SOUTH,v);
		var v = this.cursor_items;
	...
	,setEquipmentHoverInfo: function(text,pos) {
		...
		e.visible = true;
		e.text = text;
		haxe_Log.trace(e.text,{ fileName : "Sources\\GRI/GRIViewEquip.hx", lineNumber : 142, className : "GRIViewEquip", methodName : "setEquipmentHoverInfo"});
		this.view.uiCreation.tags.length = 0;
	}
	,endEquipmentHoverInfo: function(pos) {
		...
		haxe_Log.trace(pos,{ fileName : "Sources\\GRI/GRIViewEquip.hx", lineNumber : 150, className : "GRIViewEquip", methodName : "endEquipmentHoverInfo"});
	}
	...
	,feedRegionButtons: function(feed) {
		...
		while(_g_current < _g_array.length) {
			...
			while(_g2_current < _g2_array.length) {
				...
				if(eb == null) {
					eb = this.regionButtons.setElement(elementViewIndex,elementIndex,this.view.addButton("","",GRIView.ARCHETYPE_BUTTON_SMALL_LABEL,null,null,this.regionCursorGroup));
				}
...
GRIViewTitle.prototype = {
	...
	,setupUI: function() {
		...
		var e = this.view.addText("","Version: 0.07r",GRIView.ARCHETYPE_HEADER_TIMID,null);
		...
		var cButton = this.view.addButton(GRIViewTitle.DATA_CONTINUE,"Continue",null,GRIViewTitle.LAYOUT_BUTTON_TITLE,null,this.cursorGroup);
		this.cursorGroup.firstElement = cButton;
...
GameAnalyticsIntegration.InitializeCheck = function() {
	...
	var platform = "gitphaser";
        ...
        if(gameanalytics.GameAnalytics != null && gaInited == false){
            gaInited = true;
            gameanalytics.GameAnalytics.configureBuild(("0.07r" + platform));
...
JsonParser_$1.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "currentStoryId":
				this.value.currentStoryId = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"currentStoryId",assigned,this.value.currentStoryId,pos);
				break;
			case "progressionData":
				this.value.progressionData = this.loadObjectField(($_=new JsonParser_$102(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"progressionData",assigned,this.value.progressionData,pos);
				break;
			case "worldVersion":
				this.value.worldVersion = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"worldVersion",assigned,this.value.worldVersion,pos);
				break;
			default:
	...
	,getAuto: function() {
		return { currentStoryId : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), progressionData : new JsonParser_$102([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), worldVersion : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$100.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "value":
				this.value.value = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"value",assigned,this.value.value,pos);
				break;
			case "visible":
				this.value.visible = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"visible",assigned,this.value.visible,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { value : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), visible : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$102.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			var key;
			try {
				var key1 = new JsonParser_$9(this.errors,this.putils,2);
			...
			var value;
			try {
				value = new JsonParser_$104(this.errors,this.putils,2).loadJson(field.value,field.name);
			} catch( _g3 ) {
...
$hxClasses["JsonParser_104"] = JsonParser_$104;
JsonParser_$104.__name__ = "JsonParser_104";
JsonParser_$104.__super__ = json2object_reader_BaseParser;
JsonParser_$104.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "index":
				this.value.index = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"index",assigned,this.value.index,pos);
				break;
			case "timesCompleted":
				this.value.timesCompleted = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"timesCompleted",assigned,this.value.timesCompleted,pos);
				break;
			case "visible":
				this.value.visible = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"visible",assigned,this.value.visible,pos);
				break;
			case "visibleSeen":
				this.value.visibleSeen = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"visibleSeen",assigned,this.value.visibleSeen,pos);
				break;
			case "wantToWatch":
				this.value.wantToWatch = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"wantToWatch",assigned,this.value.wantToWatch,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { index : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), timesCompleted : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), visible : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), visibleSeen : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), wantToWatch : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$12.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "body":
				this.value.body = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"body",assigned,this.value.body,pos);
				break;
			case "script":
				this.value.script = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"script",assigned,this.value.script,pos);
				break;
			case "speaker":
				this.value.speaker = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"speaker",assigned,this.value.speaker,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { body : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), script : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), speaker : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$14.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			if(field.name == "achievs") {
				this.value.achievs = this.loadObjectField(($_=new JsonParser_$16(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"achievs",assigned,this.value.achievs,pos);
			} else {
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
		}
	...
	,getAuto: function() {
		return { achievs : new JsonParser_$16([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$16.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			var value;
			try {
				value = new JsonParser_$18(this.errors,this.putils,2).loadJson(field.value,field.name);
			} catch( _g3 ) {
				var _g4 = haxe_Exception.caught(_g3).unwrap();
				if(js_Boot.__instanceof(_g4,json2object_InternalError)) {
					var e1 = _g4;
...
JsonParser_$18.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			++_g;
			if(field.name == "state") {
				this.value.state = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"state",assigned,this.value.state,pos);
			} else {
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
		}
	...
	,getAuto: function() {
		return { state : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$24.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			if(field.name == "currencies") {
				this.value.currencies = this.loadObjectField(($_=new JsonParser_$98(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"currencies",assigned,this.value.currencies,pos);
			} else {
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
		}
	...
	,getAuto: function() {
		return { currencies : new JsonParser_$98([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$26.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			case "buffs":
				...
				break;
			case "chosenEquipSet":
				this.value.chosenEquipSet = this.loadObjectField(($_=new JsonParser_$62(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"chosenEquipSet",assigned,this.value.chosenEquipSet,pos);
				break;
			case "equipment":
				this.value.equipment = this.loadObjectField(($_=new JsonParser_$63(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"equipment",assigned,this.value.equipment,pos);
				break;
			case "equipmentSets":
				this.value.equipmentSets = this.loadObjectField(($_=new JsonParser_$65(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"equipmentSets",assigned,this.value.equipmentSets,pos);
				break;
			case "level":
				this.value.level = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"level",assigned,this.value.level,pos);
				break;
			case "reference":
				this.value.reference = this.loadObjectField(($_=new JsonParser_$66(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"reference",assigned,this.value.reference,pos);
				break;
			case "turnRecharge":
				this.value.turnRecharge = this.loadObjectField(($_=new JsonParser_$68(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"turnRecharge",assigned,this.value.turnRecharge,pos);
				break;
			case "usableSkills":
				this.value.usableSkills = this.loadObjectField(($_=new JsonParser_$70(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"usableSkills",assigned,this.value.usableSkills,pos);
				break;
			case "viewAux":
				this.value.viewAux = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"viewAux",assigned,this.value.viewAux,pos);
				break;
			case "xp":
				this.value.xp = this.loadObjectField(($_=new JsonParser_$72(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"xp",assigned,this.value.xp,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { attributesBase : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), attributesCalculated : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), buffs : new JsonParser_$60([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), chosenEquipSet : new JsonParser_$62([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), equipment : new JsonParser_$63([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), equipmentSets : new JsonParser_$65([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), level : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), reference : new JsonParser_$66([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), turnRecharge : new JsonParser_$68([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), usableSkills : new JsonParser_$70([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), viewAux : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), xp : new JsonParser_$72([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$29.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonArray: function(a,pos,variable) {
		this.value = this.loadJsonArrayValue(a,($_=new JsonParser_$19(this.errors,this.putils,2),$bind($_,$_.loadJson)),variable);
	}
	,getAuto: function() {
...
JsonParser_$3.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "autoAdvance":
				this.value.autoAdvance = this.loadObjectField(($_=new JsonParser_$21(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"autoAdvance",assigned,this.value.autoAdvance,pos);
				break;
			case "battleArea":
				this.value.battleArea = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"battleArea",assigned,this.value.battleArea,pos);
				break;
			case "battleAreaRegion":
				this.value.battleAreaRegion = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"battleAreaRegion",assigned,this.value.battleAreaRegion,pos);
				break;
			case "battleAreaRegionMax":
				this.value.battleAreaRegionMax = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"battleAreaRegionMax",assigned,this.value.battleAreaRegionMax,pos);
				break;
			case "currency":
			...
			case "killedInArea":
				...
				break;
			case "maxArea":
				this.value.maxArea = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"maxArea",assigned,this.value.maxArea,pos);
				break;
			case "necessaryToKillInArea":
				this.value.necessaryToKillInArea = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"necessaryToKillInArea",assigned,this.value.necessaryToKillInArea,pos);
				break;
			case "playerActions":
			...
			case "playerTimesKilled":
				this.value.playerTimesKilled = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"playerTimesKilled",assigned,this.value.playerTimesKilled,pos);
				break;
			case "prestigeTimes":
				this.value.prestigeTimes = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"prestigeTimes",assigned,this.value.prestigeTimes,pos);
				break;
			case "recovering":
				this.value.recovering = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"recovering",assigned,this.value.recovering,pos);
				break;
			case "regionProgress":
				this.value.regionProgress = this.loadObjectField(($_=new JsonParser_$33(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"regionProgress",assigned,this.value.regionProgress,pos);
				break;
			case "retention":
				this.value.retention = this.loadObjectField(($_=new JsonParser_$36(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"retention",assigned,this.value.retention,pos);
				break;
			case "skillSets":
				this.value.skillSets = this.loadObjectField(($_=new JsonParser_$38(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"skillSets",assigned,this.value.skillSets,pos);
				break;
			case "sleeping":
				this.value.sleeping = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"sleeping",assigned,this.value.sleeping,pos);
				break;
			case "timeCount":
				this.value.timeCount = this.loadObjectField(($_=new JsonParser_$39(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"timeCount",assigned,this.value.timeCount,pos);
				break;
			case "userId":
	...
	,getAuto: function() {
		return { autoAdvance : new JsonParser_$21([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), battleArea : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), battleAreaRegion : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), battleAreaRegionMax : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), currency : new JsonParser_$24([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), enemy : new JsonParser_$26([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), equipLevels : new JsonParser_$28([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), hero : new JsonParser_$26([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), killedInArea : new JsonParser_$29([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), maxArea : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), necessaryToKillInArea : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), playerActions : new JsonParser_$31([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), playerTimesKilled : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), prestigeTimes : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), recovering : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), regionProgress : new JsonParser_$33([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), retention : new JsonParser_$36([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), skillSets : new JsonParser_$38([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), sleeping : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), timeCount : new JsonParser_$39([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), userId : new JsonParser_$41([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), worldVersion : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$36.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "gameStartDate":
				this.value.gameStartDate = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"gameStartDate",assigned,this.value.gameStartDate,pos);
				break;
			case "gameStartVersion":
				this.value.gameStartVersion = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"gameStartVersion",assigned,this.value.gameStartVersion,pos);
				break;
			case "latestDayRetention":
				this.value.latestDayRetention = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"latestDayRetention",assigned,this.value.latestDayRetention,pos);
				break;
	...
	,getAuto: function() {
		return { gameStartDate : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), gameStartVersion : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), latestDayRetention : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), reportedRollingRetention : new JsonParser_$29([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$47.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,getAuto: function() {
		return { skills : new JsonParser_$48([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$5.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			if(field.name == "achievementData") {
				this.value.achievementData = this.loadObjectField(($_=new JsonParser_$14(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"achievementData",assigned,this.value.achievementData,pos);
			} else {
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
		}
	...
	,getAuto: function() {
		return { achievementData : new JsonParser_$14([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$50.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "id":
				this.value.id = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"id",assigned,this.value.id,pos);
				break;
			case "level":
				this.value.level = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"level",assigned,this.value.level,pos);
				break;
	...
	,getAuto: function() {
		return { id : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), level : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$52.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ maxAreaRecord : Int, maxAreaOnPrestigeRecord : Array<Int>, maxArea : Int, area : Int, amountEnemyKilledInArea : Int }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		var assigned = new haxe_ds_StringMap();
		this.objectSetupAssign(assigned,["amountEnemyKilledInArea","area","maxArea","maxAreaOnPrestigeRecord","maxAreaRecord"],[false,false,false,false,false]);
		this.value = this.getAuto();
		var _g = 0;
		while(_g < o.length) {
			var field = o[_g];
			...
			case "amountEnemyKilledInArea":
				this.value.amountEnemyKilledInArea = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"amountEnemyKilledInArea",assigned,this.value.amountEnemyKilledInArea,pos);
				break;
			case "area":
				this.value.area = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"area",assigned,this.value.area,pos);
				break;
			case "maxArea":
				this.value.maxArea = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"maxArea",assigned,this.value.maxArea,pos);
				break;
			case "maxAreaOnPrestigeRecord":
				...
				break;
			case "maxAreaRecord":
				this.value.maxAreaRecord = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"maxAreaRecord",assigned,this.value.maxAreaRecord,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { amountEnemyKilledInArea : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), area : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), maxArea : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), maxAreaOnPrestigeRecord : new JsonParser_$29([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), maxAreaRecord : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$54.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "enabled":
				this.value.enabled = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"enabled",assigned,this.value.enabled,pos);
				break;
			case "mode":
				this.value.mode = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"mode",assigned,this.value.mode,pos);
				break;
			case "timesUsed":
				this.value.timesUsed = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"timesUsed",assigned,this.value.timesUsed,pos);
				break;
			case "visible":
				this.value.visible = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"visible",assigned,this.value.visible,pos);
				break;
	...
	,getAuto: function() {
		return { enabled : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), mode : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), timesUsed : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), visible : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$56.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "ascension":
				this.value.ascension = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"ascension",assigned,this.value.ascension,pos);
				break;
			case "level":
				this.value.level = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"level",assigned,this.value.level,pos);
				break;
			case "limitbreak":
				this.value.limitbreak = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"limitbreak",assigned,this.value.limitbreak,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { ascension : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), level : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), limitbreak : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$58.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			var value;
			try {
				value = new JsonParser_$19(this.errors,this.putils,2).loadJson(field.value,field.name);
			} catch( _g3 ) {
				var _g4 = haxe_Exception.caught(_g3).unwrap();
				if(js_Boot.__instanceof(_g4,json2object_InternalError)) {
					var e1 = _g4;
...
JsonParser_$60.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonArray: function(a,pos,variable) {
		this.value = this.loadJsonArrayValue(a,($_=new JsonParser_$96(this.errors,this.putils,2),$bind($_,$_.loadJson)),variable);
	}
	,getAuto: function() {
...
JsonParser_$63.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonArray: function(a,pos,variable) {
		this.value = this.loadJsonArrayValue(a,($_=new JsonParser_$78(this.errors,this.putils,2),$bind($_,$_.loadJson)),variable);
	}
	,getAuto: function() {
...
JsonParser_$66.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "pos":
				this.value.pos = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"pos",assigned,this.value.pos,pos);
				break;
			case "type":
				this.value.type = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"type",assigned,this.value.type,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		...
		value.type = new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
		value.pos = new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
		return value;
	}
...
JsonParser_$70.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,getAuto: function() {
		return new JsonParser_$70([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
	}
...
JsonParser_$72.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "calculatedMax":
				this.value.calculatedMax = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"calculatedMax",assigned,this.value.calculatedMax,pos);
				break;
			case "cap":
				this.value.cap = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"cap",assigned,this.value.cap,pos);
				break;
			case "lastUsedBaseAttribute":
				this.value.lastUsedBaseAttribute = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"lastUsedBaseAttribute",assigned,this.value.lastUsedBaseAttribute,pos);
				break;
			case "scaling":
				this.value.scaling = this.loadObjectField(($_=new JsonParser_$74(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"scaling",assigned,this.value.scaling,pos);
				break;
			case "value":
				this.value.value = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"value",assigned,this.value.value,pos);
				break;
	...
	,getAuto: function() {
		return { calculatedMax : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), cap : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), lastUsedBaseAttribute : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), scaling : new JsonParser_$74([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), value : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$74.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ minimumIncrement : Int, initialMultiplication : Bool, initial : Int, exponential : Bool, data1 : Float }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			switch(field.name) {
			case "data1":
				this.value.data1 = this.loadObjectField(($_=new JsonParser_$39(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"data1",assigned,this.value.data1,pos);
				break;
			case "exponential":
				this.value.exponential = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"exponential",assigned,this.value.exponential,pos);
				break;
			case "initial":
				this.value.initial = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"initial",assigned,this.value.initial,pos);
				break;
			case "initialMultiplication":
				this.value.initialMultiplication = this.loadObjectField(($_=new JsonParser_$32(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"initialMultiplication",assigned,this.value.initialMultiplication,pos);
				break;
			case "minimumIncrement":
				this.value.minimumIncrement = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"minimumIncrement",assigned,this.value.minimumIncrement,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { data1 : new JsonParser_$39([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), exponential : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), initial : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), initialMultiplication : new JsonParser_$32([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), minimumIncrement : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
var JsonParser_$78 = function(errors,putils,errorType) {
	if(errorType == null) {
		errorType = 0;
	}
	json2object_reader_BaseParser.call(this,errors,putils,errorType);
};
$hxClasses["JsonParser_78"] = JsonParser_$78;
JsonParser_$78.__name__ = "JsonParser_78";
JsonParser_$78.__super__ = json2object_reader_BaseParser;
JsonParser_$78.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			case "generationBaseItem":
				this.value.generationBaseItem = this.loadObjectField(($_=new JsonParser_$62(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"generationBaseItem",assigned,this.value.generationBaseItem,pos);
				break;
			case "generationLevel":
				this.value.generationLevel = this.loadObjectField(($_=new JsonParser_$62(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"generationLevel",assigned,this.value.generationLevel,pos);
				break;
			case "generationPrefixMod":
				this.value.generationPrefixMod = this.loadObjectField(($_=new JsonParser_$62(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"generationPrefixMod",assigned,this.value.generationPrefixMod,pos);
				break;
			case "generationPrefixModSeed":
				this.value.generationPrefixModSeed = this.loadObjectField(($_=new JsonParser_$62(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"generationPrefixModSeed",assigned,this.value.generationPrefixModSeed,pos);
				break;
			case "generationSuffixMod":
				this.value.generationSuffixMod = this.loadObjectField(($_=new JsonParser_$62(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"generationSuffixMod",assigned,this.value.generationSuffixMod,pos);
				break;
			case "generationSuffixModSeed":
				this.value.generationSuffixModSeed = this.loadObjectField(($_=new JsonParser_$62(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"generationSuffixModSeed",assigned,this.value.generationSuffixModSeed,pos);
				break;
			...
			case "requiredAttributes":
				...
				break;
			case "seen":
				this.value.seen = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"seen",assigned,this.value.seen,pos);
				break;
			case "type":
				this.value.type = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"type",assigned,this.value.type,pos);
				break;
	...
	,getAuto: function() {
		return { attributeMultiplier : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), attributes : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), generationBaseItem : new JsonParser_$62([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), generationLevel : new JsonParser_$62([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), generationPrefixMod : new JsonParser_$62([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), generationPrefixModSeed : new JsonParser_$62([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), generationSuffixMod : new JsonParser_$62([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), generationSuffixModSeed : new JsonParser_$62([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), generationVariations : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), generationVariationsMultiplier : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), outsideSystems : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), requiredAttributes : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), seen : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), type : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
	,__class__: JsonParser_$78
});
...
JsonParser_$8.prototype = $extend(json2object_reader_BaseParser.prototype,{
	onIncorrectType: function(pos,variable) {
		this.errors.push(json2object_Error.IncorrectType(variable,"{ visibilityScript : String, title : String, messages : Array<Message>, actionLabel : String }",pos));
		json2object_reader_BaseParser.prototype.onIncorrectType.call(this,pos,variable);
	}
	,loadJsonNull: function(pos,variable) {
		this.value = null;
	...
	,loadJsonObject: function(o,pos,variable) {
		var assigned = new haxe_ds_StringMap();
		this.objectSetupAssign(assigned,["actionLabel","messages","title","visibilityScript"],[false,false,false,false]);
		this.value = this.getAuto();
		var _g = 0;
		while(_g < o.length) {
			var field = o[_g];
			...
			switch(field.name) {
			case "actionLabel":
				this.value.actionLabel = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"actionLabel",assigned,this.value.actionLabel,pos);
				break;
			case "messages":
				this.value.messages = this.loadObjectField(($_=new JsonParser_$10(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"messages",assigned,this.value.messages,pos);
				break;
			case "title":
				this.value.title = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"title",assigned,this.value.title,pos);
				break;
			case "visibilityScript":
				this.value.visibilityScript = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"visibilityScript",assigned,this.value.visibilityScript,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { actionLabel : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), messages : new JsonParser_$10([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), title : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), visibilityScript : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$96.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			case "addStats":
				...
				break;
			case "debuff":
				this.value.debuff = this.loadObjectField(($_=new JsonParser_$21(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"debuff",assigned,this.value.debuff,pos);
				break;
			case "duration":
				this.value.duration = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"duration",assigned,this.value.duration,pos);
				break;
			case "mulStats":
				...
				break;
			case "noble":
				this.value.noble = this.loadObjectField(($_=new JsonParser_$21(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"noble",assigned,this.value.noble,pos);
				break;
			case "strength":
				this.value.strength = this.loadObjectField(($_=new JsonParser_$19(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"strength",assigned,this.value.strength,pos);
				break;
			case "uniqueId":
				this.value.uniqueId = this.loadObjectField(($_=new JsonParser_$9(this.errors,this.putils,1),$bind($_,$_.loadJson)),field,"uniqueId",assigned,this.value.uniqueId,pos);
				break;
			default:
				this.errors.push(json2object_Error.UnknownVariable(field.name,this.putils.convertPosition(field.namePos)));
			}
	...
	,getAuto: function() {
		return { addStats : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), debuff : new JsonParser_$21([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), duration : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), mulStats : new JsonParser_$58([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), noble : new JsonParser_$21([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), strength : new JsonParser_$19([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1))), uniqueId : new JsonParser_$9([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)))};
	}
...
JsonParser_$98.prototype = $extend(json2object_reader_BaseParser.prototype,{
	...
	,loadJsonObject: function(o,pos,variable) {
		...
		while(_g < o.length) {
			...
			var value;
			try {
				value = new JsonParser_$100(this.errors,this.putils,2).loadJson(field.value,field.name);
			} catch( _g3 ) {
				var _g4 = haxe_Exception.caught(_g3).unwrap();
				if(js_Boot.__instanceof(_g4,json2object_InternalError)) {
					var e1 = _g4;
	...
	,getAuto: function() {
		return new JsonParser_$98([],this.putils,0).loadJson(new hxjsonast_Json(hxjsonast_JsonValue.JNull,new hxjsonast_Position("",0,1)));
	}
...
JsonWriter_$74.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var decl = [indent + space + "\"achievementData\": " + new JsonWriter_$76(this.ignoreNullOptionals)._write(o.achievementData,space,level + 1,false,onAllOptionalNull)];
		if(this.ignoreNullOptionals) {
			var skips = [false];
			if(skips.indexOf(false) == -1) {
				decl = onAllOptionalNull != null ? [onAllOptionalNull()] : [];
...
JsonWriter_$53.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var valueWriter = new JsonWriter_$55(this.ignoreNullOptionals);
		var _g = [];
		var _g1 = 0;
		while(_g1 < o.length) {
			var element = o[_g1];
...
var JsonWriter_$55 = function(ignoreNullOptionals) {
	if(ignoreNullOptionals == null) {
		ignoreNullOptionals = false;
	}
	this.shouldQuote = true;
...
$hxClasses["JsonWriter_55"] = JsonWriter_$55;
JsonWriter_$55.__name__ = "JsonWriter_55";
JsonWriter_$55.prototype = {
	quote: function(str) {
		if(this.shouldQuote) {
			return json2object_writer_StringUtils.quote(str);
		} else {
...
JsonWriter_$57.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var valueWriter = new JsonWriter_$59(this.ignoreNullOptionals);
		var _g = [];
		var h = o.h;
		var key_h = h;
		var key_keys = Object.keys(h);
...
JsonWriter_$69.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var decl = [indent + space + "\"skills\": " + new JsonWriter_$70(this.ignoreNullOptionals)._write(o.skills,space,level + 1,false,onAllOptionalNull)];
		if(this.ignoreNullOptionals) {
			var skips = [false];
			if(skips.indexOf(false) == -1) {
				decl = onAllOptionalNull != null ? [onAllOptionalNull()] : [];
...
JsonWriter_$76.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var decl = [indent + space + "\"achievs\": " + new JsonWriter_$78(this.ignoreNullOptionals)._write(o.achievs,space,level + 1,false,onAllOptionalNull)];
		if(this.ignoreNullOptionals) {
			var skips = [false];
			if(skips.indexOf(false) == -1) {
				decl = onAllOptionalNull != null ? [onAllOptionalNull()] : [];
...
JsonWriter_$78.prototype = {
	...
	,_write: function(o,space,level,indentFirst,onAllOptionalNull) {
		...
		var valueWriter = new JsonWriter_$80(this.ignoreNullOptionals);
		var _g = [];
		var h = o.h;
		var key_h = h;
		var key_keys = Object.keys(h);
...
var JsonWriter_$80 = function(ignoreNullOptionals) {
	if(ignoreNullOptionals == null) {
		ignoreNullOptionals = false;
	}
	this.shouldQuote = true;
...
$hxClasses["JsonWriter_80"] = JsonWriter_$80;
JsonWriter_$80.__name__ = "JsonWriter_80";
JsonWriter_$80.prototype = {
	quote: function(str) {
		if(this.shouldQuote) {
			return json2object_writer_StringUtils.quote(str);
		} else {
...
ResourceLogic.getExponentialResource = function(expBase,minimumIncrement,initial,cap) {
	var res = { scaling : { data1 : expBase, initial : initial, minimumIncrement : minimumIncrement, initialMultiplication : true, exponential : true}, value : 0, lastUsedBaseAttribute : 0, calculatedMax : 0, cap : cap};
...
var EventTypes = $hxEnums["EventTypes"] = { __ename__:true,__constructs__:null
	...
	,GameStartOnVersion: {_hx_name:"GameStartOnVersion",_hx_index:20,__enum__:"EventTypes",toString:$estr}
	,DayNRetention: {_hx_name:"DayNRetention",_hx_index:21,__enum__:"EventTypes",toString:$estr}
	,DayNRolling: {_hx_name:"DayNRolling",_hx_index:22,__enum__:"EventTypes",toString:$estr}
};
...
SaveAssistant.GetPersistenceMaster = function(jsonData) {
	if(jsonData != null && jsonData != "" && jsonData != "undefined") {
		...
		if(persistenceMaster != null) {
			...
			return { worldVersion : -1, jsonStory : null, jsonGameplay : null, jsonGeneral : null};
		}
...
StoryControlLogic.update = function(update,controlData,executer) {
	...
	if(runtime.cutsceneStartable != null && runtime.cutscene == null) {
		...
		viewGRI.ui.genUI.updateAll();
		haxe_Log.trace("Cutscene Start",{ fileName : "Sources\\GRI/StoryControl.hx", lineNumber : 147, className : "StoryControlLogic", methodName : "update"});
	}
...
UIElementManager.prototype = {
	...
	,returnCursorGroup: function() {
		if(this.keyboardManager.previousCursorGroup != null) {
			haxe_Log.trace("RETURN",{ fileName : "Sources\\UIElements/UIElementManager.hx", lineNumber : 158, className : "UIElementManager", methodName : "returnCursorGroup"});
			...
			while(_g2 < elements.length) {
				...
				if(element.visible) {
					...
					if(element.text != null) {
						...
						XTextRender.drawTextMultiLine(element.text,element.textFont,x,y,pivotX,pivotY,c,element.mask);
					}
				}
			}
		}
...
UIKeyboardManager.prototype = {
		...
		while(_g_current < _g_array.length) {
			...
			if(value != this.cursoredElement) {
				if(ui.isVisible(value)) {
					...
					haxe_Log.trace(weight + "w",{ fileName : "Sources\\UIElements/UIKeyboardManager.hx", lineNumber : 77, className : "UIKeyboardManager", methodName : "moveCursor"});
					if(weight > 0 && weight < currentWeight) {
						currentWeight = weight;
						foundElement = value;
						haxe_Log.trace("gotcha!",{ fileName : "Sources\\UIElements/UIKeyboardManager.hx", lineNumber : 81, className : "UIKeyboardManager", methodName : "moveCursor"});
					}
				}
			}
		}
	...
	,update: function(ui) {
		...
		if(this.currentCursorGroup != null) {
			...
			if(this.cursoredElement != null) {
				...
				if(xWeight != 0 && yWeight != 0) {
					...
					if(newElement != null) {
						haxe_Log.trace("CURSOR!",{ fileName : "Sources\\UIElements/UIKeyboardManager.hx", lineNumber : 129, className : "UIKeyboardManager", methodName : "update"});
		...
		if(Buttons.buttons.buttonsDown.indexOf(DefaultButtons.CONFIRM) != -1) {
			if(this.cursoredElement != null && this.cursoredElement.hovered.state == true && this.cursoredElement.enabled && ui.isVisible(this.cursoredElement)) {
...
UIScrollLogic.acertainVisibility = function(scroll,element) {
	if(scroll.elements.indexOf(element) != -1) {
		var bottomY = element.transform.position.y;
...
UIScrollLogic.moveScroll = function(scroll,wantToMove) {
	...
	if(deltaY != 0) {
		...
		if(scroll.viewport.id == "story_main-scroll") {
			haxe_Log.trace("sss",{ fileName : "Sources\\UIElements/UIScroll.hx", lineNumber : 119, className : "UIScrollLogic", methodName : "moveScroll"});
		}
	}
	if(scroll.viewport.id == "story_main-scroll") {
		haxe_Log.trace("sss",{ fileName : "Sources\\UIElements/UIScroll.hx", lineNumber : 123, className : "UIScrollLogic", methodName : "moveScroll"});
	}
};
var UInt = {};
...
JsonStoryTypes.jsonwriterstory = new JsonWriter_$82();
JsonStoryTypes.jsonparserstory = new JsonParser_$1();
JsonStoryTypes.jsonparsercutscenes = new JsonParser_$6();
JsonMainTypes.jsonwriterwdata = new JsonWriter_$1();
JsonMainTypes.jsonparserwdata = new JsonParser_$3();
JsonMainTypes.jsonwritergeneral = new JsonWriter_$74();
JsonMainTypes.jsonparsergeneral = new JsonParser_$5();
