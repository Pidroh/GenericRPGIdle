...
var BattleManager = function() {
	...
	if(bm.regionPrizes.length > bm.regionRequirements.length) {
		haxe_Log.trace("PROBLEM: Tell developer to add more region requirements!!!",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 1046, className : "BattleManager", methodName : "new"});
	}
...
BattleManager.prototype = {
	...
	,DiscardWorseEquipment: function() {
		...
		while(i < this.wdata.hero.equipment.length) {
			++times;
			if(times > 500) {
				haxe_Log.trace("LOOP SCAPE",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2294, className : "BattleManager", methodName : "DiscardWorseEquipment"});
				break;
			}
			var e = this.wdata.hero.equipment[i];
			if(e == null) {
			...
			while(j < this.wdata.hero.equipment.length) {
				++times2;
				if(times2 > 500) {
					haxe_Log.trace("LOOP SCAPE 2",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2311, className : "BattleManager", methodName : "DiscardWorseEquipment"});
					break;
				}
	...
	,SendJsonPersistentData: function(jsonString,verbose) {
		...
		try {
			...
			if(loadedWdata.worldVersion <= 3003) {
				haxe_Log.trace("legacy save ",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2471, className : "BattleManager", methodName : "SendJsonPersistentData"});
				loadedWdata = this.sendJsonLegacy(jsonString);
			}
		} catch( _g ) {
			var e = haxe_Exception.caught(_g);
			haxe_Log.trace("load save failed ",{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2476, className : "BattleManager", methodName : "SendJsonPersistentData"});
			haxe_Log.trace(e.get_message(),{ fileName : "Sources\\GRI\\logic/BattleManager.hx", lineNumber : 2477, className : "BattleManager", methodName : "SendJsonPersistentData"});
			return false;
		}
...
GRIControl.prototype = {
	setupTitle: function() {
		...
		haxe_Log.trace(res,{ fileName : "Sources\\GRI/GRIControl.hx", lineNumber : 185, className : "GRIControl", methodName : "setupTitle"});
	...
	,setupView: function() {
		...
		var createButtonFromAction = function(actionId,label,buttontype,layoutid,warning) {
			...
			_gthis.view.addButton(actionId,label,buttontype,layoutid,null,_gthis.view.mainCursorGroup);
...
GRIViewTitle.prototype = {
	...
	,setupUI: function() {
		...
		var e = this.view.addText("","Version: 0.06r",GRIView.ARCHETYPE_HEADER_TIMID,null);
...
GameAnalyticsIntegration.InitializeCheck = function() {
	...
	var platform = "gitphaser";
        ...
        if(gameanalytics.GameAnalytics != null && gaInited == false){
            gaInited = true;
            gameanalytics.GameAnalytics.configureBuild(("0.06r" + platform));
...
RetentionLogic.prototype = {
	...
	,checkAndSendRetentionEvents: function(rd,gameStartDate) {
...
StoryControlLogic.update = function(update,controlData,executer) {
	...
	if(runtime.cutsceneStartable != null && runtime.cutscene == null) {
		...
		viewGRI.ui.genUI.updateAll();
		haxe_Log.trace("Cutscene Start",{ fileName : "Sources\\GRI/StoryControl.hx", lineNumber : 169, className : "StoryControlLogic", methodName : "update"});
	}
		...
		while(_g_current < _g_array.length) {
			...
			if(value != this.cursoredElement) {
				if(ui.isVisible(value)) {
					...
					haxe_Log.trace(weight + "w",{ fileName : "Sources\\UIElements/UIKeyboardManager.hx", lineNumber : 72, className : "UIKeyboardManager", methodName : "moveCursor"});
					if(weight > 0 && weight < currentWeight) {
						currentWeight = weight;
						foundElement = value;
						haxe_Log.trace("gotcha!",{ fileName : "Sources\\UIElements/UIKeyboardManager.hx", lineNumber : 76, className : "UIKeyboardManager", methodName : "moveCursor"});
					}
				}
			}
		}
		...
		if(this.currentCursorGroup != null) {
			...
			if(this.cursoredElement != null) {
				...
				if(xWeight != 0 && yWeight != 0) {
					...
					if(newElement != null) {
						haxe_Log.trace("CURSOR!",{ fileName : "Sources\\UIElements/UIKeyboardManager.hx", lineNumber : 119, className : "UIKeyboardManager", methodName : "update"});
